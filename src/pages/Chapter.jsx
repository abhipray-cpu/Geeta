...
export default function Chapter(){
    ...
    return(
        <div className="w-screen min-h-screen bg-white py-2">
            <div className="pl-3 pt-3 flex flex-col items-center justify-center">
            <img src={Logo} alt="Jai Shree Ram" className='w-10 h-10' />
                <h3 className=' text-orange-500 text-xl lg:text-2xl font-medium font-mono tracking-wider'>Chapter{data.chapter_number}</h3>
                <h3 className=' text-orange-500 text-xl lg:text-2xl font-medium font-mono tracking-wider mt-3'>{data.name}</h3>
                <h3 className=' text-orange-500 text-xl lg:text-2xl font-normal font-mono tracking-wider mt-1'>{data.meaning['hi']}({data.meaning['en']})</h3>
                <div className="w-[94vw] lg:w-[60vw] mt-4">
                <p className="mb-3 lg:text-center"><strong className="text-orange-500 text-xl lg:text-2xl font-normal font-mono tracking-wider">Hindi:</strong>{data.summary['hi']}</p>
                <p className="mb-3 lg:text-center"><strong className="text-orange-500 text-xl lg:text-2xl font-normal font-mono tracking-wider">English:</strong> {data.summary['en']}</p>
                </div>

                <h2 className=' text-orange-500 text-xl lg:text-2xl font-medium font-mono tracking-wider mt-3'>Verses</h2>
                <div className="flex flex-row flex-wrap justify-center w-[96vw] lg:w-[60vw]">
                {Array.from({ length: data.verses_count }, (_, index) => (
                       <div key={index} className="cursor-pointer" onClick={()=>{navigate(`/shlok/${data.chapter_number}/${index+1}`)}}>
                       <Player
            src={BookJSON}
            loop
            autoplay
          ...
          /> 
          <h1 className='text-center text-orange-600 font-normal font-sans text-lg lg:text-xl tracking-wide -mt-10 lg:-mt-5'>Verse{index+1}</h1>
                       </div>
      ))}
                </div>
            </div>
