    ...
    return(
        <div className="w-screen min-h-screen bg-white py-2">
            <div className="pl-3 pt-3 flex flex-col items-center">
                ...
                {comp === 0 && (<div className='flex flex-row flex-wrap justify-center w-screen lg:w-[80vw] -mt-7'>
                    {
                        data.map((val,index)=>(
                            <div key={index} className='cursor-pointer -mb-10' onClick={()=>{navigate(`/chapter/${index+1}`)}}>
                            <Player
            src={BookJSON}
            loop
            autoplay
          ...
          /> 
          <h1 className='text-center text-orange-600 font-medium font-sans text-xl lg:text-3xl tracking-wide -mt-20 lg:-mt-10'>{val.name}</h1>
                            </div>
                        ))
                    }
                </div>)}
